...
- **Расписание.** В настройках задаются дни и часы работы; вне окна Screenloop один раз шлёт `Stop` и больше телевизор не трогает. По умолчанию выключено — обновление не должно само гасить чужие экраны. У каждого ТВ можно поставить своё окно или вывести его из расписания совсем.
