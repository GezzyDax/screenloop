  ...
  <section v-else class="stack">
    <div class="panel security-panel">
      <div class="section-head">
        ...
        <a class="button-link ghost" href="/api/v1/diagnostics">{{ t("diagnostics") }}</a>
      </div>
    ...
    <div class="panel">
      ...
      <div class="row-actions docs-actions">
        <a class="button-link" href="/docs">{{ t("openApiDocs") }}</a>
        <a class="button-link ghost" href="/redoc">{{ t("openRedoc") }}</a>
      </div>
    </div>
  </section>
</template>
