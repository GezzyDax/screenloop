...
ONLINE_POLL = float(_env("SCREENLOOP_ONLINE_POLL", "5"))
SSDP_TIMEOUT = float(_env("SCREENLOOP_SSDP_TIMEOUT", "2"))
DLNA_WARMUP = int(_env("SCREENLOOP_DLNA_WARMUP", "8"))
SOAP_TIMEOUT = float(_env("SCREENLOOP_SOAP_TIMEOUT", "20"))
SOAP_NEXT_TIMEOUT = float(_env("SCREENLOOP_SOAP_NEXT_TIMEOUT", "3"))
...
AUTO_ADVANCE_END_GRACE = int(_env("SCREENLOOP_AUTO_ADVANCE_END_GRACE", "5"))
